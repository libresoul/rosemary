...
<div class="h-[--dont-overflow] flex items-center justify-center p-4 border border-pink-300 rounded-lg shadow">
    <div class="w-[400px] text-center p-[30px] rounded-xl">
        ...
        <div class="flex justify-center mt-5 space-x-4">
            <a href="https://www.instagram.com" class="flex items-center px-4 py-2 text-pink-100 bg-pink-700 rounded-lg hover:bg-pink-600 focus:ring-4 focus:ring-pink-300 hover:scale-125 transition-all duration-500 m-2">
            ...
            <a href="https://www.facebook.com" class="flex items-center px-4 py-2 text-pink-100 bg-pink-700 rounded-lg hover:bg-pink-600 focus:ring-4 focus:ring-pink-300 hover:scale-125 transition-all duration-500 m-2">
